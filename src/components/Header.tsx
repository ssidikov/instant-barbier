  ...
  return (
    <header 
      ...
      style={{
        ...
        borderBottom: scrolled ? '1px solid rgba(156, 131, 88, 0.3)' : '1px solid rgba(156, 131, 88, 0.15)',
        boxShadow: scrolled 
    ...
    >
      ...
      <div className='max-w-7xl mx-auto px-6 h-24 flex items-center justify-between relative'>
        ...
        <nav ref={navRef} className='hidden lg:flex items-center space-x-10'>
          {navItems.map((item, index) => (
            ...
            >
              <span className="relative z-10 [text-shadow:_0_1px_8px_rgb(11_22_34_/_80%)]">{item.label}</span>
              {/* Animated underline */}
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(11, 22, 34, 0.98) 0%, rgba(11, 22, 34, 0.95) 100%)',
      ...
      <div className={`absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-gold/30 to-transparent transition-opacity duration-500 ${scrolled ? 'opacity-100' : 'opacity-0'}`} />
    </header>
  )
}
