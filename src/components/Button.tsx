...
export default function Button({ children, href, className = '' }: ButtonProps) {
  return (
    <a
      ...
      {/* Text */}
      <span className='relative block text-center px-10 py-5 md:px-6 md:py-4 text-gold group-hover:text-navy uppercase tracking-[0.15em] md:tracking-[0.2em] text-xs md:text-sm font-semibold transition-all duration-300'>
        {children}
      </span>
