        ...
        <div className='flex flex-col md:flex-row flex-wrap justify-between items-center gap-6 border-b border-cream/10 pb-12 mb-12'>
          ...
          <div className='flex flex-col md:flex-row items-center gap-6 text-cream/80'>
            ...
            <div className='flex items-center gap-3'>
              ...
              <a href={CONTACT.phoneHref} className='text-sm uppercase tracking-wide hover:text-gold transition-colors'>{CONTACT.phone}</a>
            </div>
            <div className='hidden md:block w-px h-4 bg-cream/20'></div>
            <div className='flex items-center gap-3'>
              <div className='w-10 h-10 border border-gold/30 flex items-center justify-center'>
              ...
              <a href={`mailto:${CONTACT.email}`} className='text-sm uppercase tracking-wide hover:text-gold transition-colors'>{CONTACT.email}</a>
            </div>
          </div>
