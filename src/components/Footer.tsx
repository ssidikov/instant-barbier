    ...
    <footer className='bg-dark pt-16 pb-8 overflow-hidden'>
      <div className='max-w-6xl mx-auto px-5 md:px-6 lg:px-8'>
        ...
        <div className='flex flex-col md:flex-row flex-wrap justify-between items-center gap-4 md:gap-6 border-b border-cream/10 pb-8 md:pb-12 mb-8 md:mb-12'>
            ...
            {[
              {
                ...
                content: <span className='text-sm uppercase tracking-wide'>{CONTACT.address}</span>,
              },
              {
                icon: (
                  <svg
          ...
          <Reveal variant='fade-up' delay={0.5} threshold={0.1}>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-8 mb-12 md:mb-16'>
          {/* Left Column - Legal */}
          <Reveal variant='fade-up' delay={0.6} threshold={0.1}>
            <div className='flex flex-col items-center md:items-start gap-6'>
              <div className='flex flex-col gap-2'>
                <h3 className='text-gold font-medium mb-1 uppercase tracking-wider text-sm'>
                  Légal
                </h3>
                <Link
                  href='/legal'
          ...
          {/* Right Column - Pages */}
          <Reveal variant='fade-up' delay={0.7} threshold={0.1}>
