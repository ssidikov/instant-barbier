    ...
    <footer className='bg-dark pt-16 pb-8 overflow-hidden'>
      <div className='max-w-6xl mx-auto px-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 mb-16'>
          {/* Left Column - Social Icons & Legal */}
          ...
          <div className='text-center md:text-left'>
            <h3 className='text-gold font-medium mb-3 uppercase tracking-wider text-sm'>Adresse</h3>
            <div className='space-y-1 text-cream/80 text-sm'>
              <p>43 rue de Turenne</p>
              <p>75003 Paris</p>
              <p className='mt-2'>contact@linstant-barbier.fr</p>
            </div>
          </div>
        ...
        <p className='text-center text-xs text-cream/40 mt-6'>
          © {new Date().getFullYear()} L&apos;Instant Barbier. Tous droits réservés.
        </p>
      </div>
    </footer>
  )
